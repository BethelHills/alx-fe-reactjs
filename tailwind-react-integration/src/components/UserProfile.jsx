  ...
  return (
    <div className="user-profile bg-gray-100 p-4 md:p-8 max-w-xs md:max-w-sm mx-auto my-20 rounded-lg shadow-lg">
      <div className="md:flex items-center">
        <img
          className="rounded-full w-28 h-28 md:w-36 md:h-36 mx-auto md:mx-0 md:mr-6 object-cover border-2 border-indigo-500"
          src="https://via.placeholder.com/150"
          alt="User"
        />
        <div className="text-center md:text-left">
          <h1 className="text-xl md:text-2xl text-blue-800 font-semibold my-4">John Doe</h1>
